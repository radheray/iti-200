function callApi() {
  ...
  xhr.open(
    "POST",
    "http://ec2-13-52-251-175.us-west-1.compute.amazonaws.com:3000/search",
    true
  );
...
function displayResults(response) {
  ...
  document.getElementById("buybutton").addEventListener("click", function () {
    ...
    xhr.open(
      "POST",
      "http://ec2-13-52-251-175.us-west-1.compute.amazonaws.com:3000/cart/add",
      true
    );
    xhr.setRequestHeader("Content-Type", "application/json");
    xhr.onreadystatechange = function () {
...
$(document).on("click", ".add-to-cart-btn", function () {
  ...
  $.ajax({
    url: "http://ec2-13-52-251-175.us-west-1.compute.amazonaws.com:3000/cart/add",
    method: "POST",
...
function loadCartItems() {
  ...
  $.ajax({
    url: "http://ec2-13-52-251-175.us-west-1.compute.amazonaws.com:3000/cart/items",
    method: "GET",
    success: function (response) {
